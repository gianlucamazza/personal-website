...
const Header = () => {
  ...
  return (
    <header className={`fixed w-full z-50 transition-all duration-300 font-mono ${isScrolled ? 'bg-[#0a0f1c]/95 backdrop-blur-sm border-b border-green-500/20' : 'bg-transparent'
      }`}>
